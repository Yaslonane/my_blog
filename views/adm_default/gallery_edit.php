                ...
                <label class="col-sm-2 control-label">Опубликован</label>
                    <div class="col-sm-6">
                        <select class="form-control m-bot15" name="is_public">
                            <option value="1" <?php if($album['is_public'] == 1):?> selected <?php endif; ?>>Опубликован</option>
                            <option value="0" <?php if($album['is_public'] == 0):?> selected <?php endif; ?>>Снят с публикации</option>
                        </select>
                    </div>
            </div>
