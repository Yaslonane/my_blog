<?php require_once 'header.php'; //подключаем header?> 
    ...
    <div class="wrapper">
        ...
        <tr class="gradeA">
            ...
            <td>
                <a href="<?php DOMAIN; ?>/adminpanel/publicgallery/<?php echo $gallery['id']; ?>" > <i <?php echo ($gallery['is_public'] == 0) ? 'class="fa fa-times"  style="font-size:20px; color:#cc0000 "' : "class='fa fa-check'"; ?>></i></a>
            </td>
